...
const { getSnippets,
    ...
    adminDeleteSnippet, 
    toggleSaveSnippet,
    getSavedSnippets} = require("../controller/snippetController")
...
router.post('/save/:id', verifyAccessToken, toggleSaveSnippet)
router.get('/saved/me', verifyAccessToken, getSavedSnippets)
